...
🔧 Features
Manual ON/OFF: Turn the relay on and off with dedicated buttons.
Timer function: Keep the relay on for a specific time, and automatically turn it off when the time is up.
